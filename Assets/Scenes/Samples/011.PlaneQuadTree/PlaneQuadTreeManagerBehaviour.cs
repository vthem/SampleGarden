...
public class PlaneQuadTreeManagerBehaviour : MonoBehaviour
{
	...
	void Start()
	{
		Debug.Log("create root QuadTree");
	...
	private void Update()
	{
		...
		Vector2 position = new Vector2(posObj.transform.position.x, posObj.transform.position.z);
		//Vector2 position = new Vector2(7.5f, 7.5f);
